...
import 'package:qbooking/profile/widget/button_agree_term_provacy.dart';

class PrivacyHomePage extends StatelessWidget {
  const PrivacyHomePage({super.key});
      ...
      body: const Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 100,),
            ButtonTermAndProvacy(titlebtn: "I've agree with this",)
          ],
        ),
      ),
    );
