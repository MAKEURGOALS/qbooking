...
List<ResponseFindManyBookingModel> responseFindManyBookingModelFromJson(
        String str) =>
    List<ResponseFindManyBookingModel>.from(
        json.decode(str).map((x) => ResponseFindManyBookingModel.fromJson(x)));

String responseFindManyBookingModelToJson(
        List<ResponseFindManyBookingModel> data) =>
...
class ResponseFindManyBookingModel {
  ...
  factory ResponseFindManyBookingModel.fromJson(Map<String, dynamic> json) =>
      ResponseFindManyBookingModel(
        id: json["_id"],
