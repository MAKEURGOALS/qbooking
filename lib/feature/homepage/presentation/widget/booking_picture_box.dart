...
class BookingPictureBox extends StatefulWidget {
  const BookingPictureBox({super.key, required this.roomData});
  final RoomId roomData;

  @override
  State<BookingPictureBox> createState() => _BookingPictureBoxState();
}

class _BookingPictureBoxState extends State<BookingPictureBox>
